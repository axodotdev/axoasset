...
pub enum AxoassetError {
    ...
    #[help("Axoasset cannot create remote assets; Did you mean to create a local asset? You can do so by passing a local path.")]
    ...
    #[help("Make sure the url you prodived is accurate.")]
    ...
    #[help("Please use an http or https url or a local path.")]
    ...
    #[help("Make sure your server is configured correctly and your destination path has the correct permissions.")]
    ...
    #[help("Please make sure the asset url is correct and that the server is properly configured")]
    ...
    #[help("Make sure your path is correct and your server is configured correctly.")]
    ...
    #[help("Make sure your path is relative to your oranda config or project manifest file.")]
    LocalAssetNotFound {
        /// The origin path of the asset, used as an identifier
        origin_path: String,
        /// Details of the error
    ...
    /// provided path.
    #[error("failed to read asset from {origin_path}: An error occured while reading the asset at provided path.")]
    #[help("Make sure your path is relative to your oranda config or project manifest file.")]
